#ifndef IMU_CTRL_INC_VQF_H_
#define IMU_CTRL_INC_VQF_H_
...
void quat_local_to_global(float qw, float qx, float qy, float qz,
		float x_in, float y_in, float z_in,
		float* x_out, float* y_out, float* z_out);
void quat_local_to_global_sagittal(float qw, float qx, float qy, float qz,
		float ax_in, float ay_in, float az_in,
		float* ax_out, float* ay_out, float* az_out);
void GetEulerAnglesWithObject(AS_IMU_Euler_t* euler, \
		AS_IMU_Accel_t* accel_local, AS_IMU_Accel_t* accel_bodyframe, \
		AS_IMU_Gyro_t* gyro_local, AS_IMU_Gyro_t* gyro_global, \
		VQF_t* vqfObject);

#endif /* IMU_CTRL_INC_VQF_H_ */
