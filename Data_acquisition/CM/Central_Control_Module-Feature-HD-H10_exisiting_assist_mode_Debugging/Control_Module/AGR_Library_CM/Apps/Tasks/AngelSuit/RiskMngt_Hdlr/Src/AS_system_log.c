...
extern float 			 RH_IMU_TVCFDeg_sagittal;		// TVCF RH
extern float 			 LH_IMU_TVCFDeg_sagittal;		// TVCF LH
...
//	Append_SD_Data_Float16(log_data, CONV_FLOAT16, RH_IMU_TVCFDeg_sagittal, DEG_ENC_RANGE_MAX);
//	Append_SD_Data_Float16(log_data, CONV_FLOAT16, LH_IMU_TVCFDeg_sagittal, DEG_ENC_RANGE_MAX);
