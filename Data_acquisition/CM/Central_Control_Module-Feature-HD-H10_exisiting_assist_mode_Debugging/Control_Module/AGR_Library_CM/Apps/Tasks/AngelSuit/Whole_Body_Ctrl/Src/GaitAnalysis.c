...
// 상체 각도
float Theta_Trunk_Improved = 0.0f; // 0.5 * (RH Thigh + LH thigh)
...
void GaitAnalysis_Improved(void)
{
    ...
    Theta_Trunk_Improved = 0.5 * ((RH_Sagittal.IMU_TVCFDeg_sagittal) + (LH_Sagittal.IMU_TVCFDeg_sagittal)) - TrunkNeutralPostureBias;
    // For Extension Board
