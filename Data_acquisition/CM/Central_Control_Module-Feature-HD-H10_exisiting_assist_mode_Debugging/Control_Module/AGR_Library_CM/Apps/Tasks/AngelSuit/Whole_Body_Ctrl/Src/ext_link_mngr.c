...
void ExtLinkMngr_Init(void) {
    ...
    /* SUIT H10 data */
	_ExtLink_CreatePDO(CMEXT_LINK_DICT_ID_CM_to_EXT, CMEXT_LINK_PDO_ID_CM_to_EXT_LEFT_HIP_TORQUE,       DOP_INT16, 1, &ScaledDataObj.Scaled_ActualCurrentRH);
    _ExtLink_CreatePDO(CMEXT_LINK_DICT_ID_CM_to_EXT, CMEXT_LINK_PDO_ID_CM_to_EXT_RIGHT_HIP_TORQUE,      DOP_INT16, 1, &ScaledDataObj.Scaled_ActualCurrentLH);
    /* imu data */
...
void ScalingForPDOSendToExt(void) {
    ...
    ScaledDataObj.Scaled_leftHipImuFrontalRoll = ScaleFloatToInt16(LH_Sagittal.IMU_TVCFDeg_frontal, DEG_SCALING_FACTOR);
	ScaledDataObj.Scaled_leftHipImuSagittalPitch = ScaleFloatToInt16(LH_Sagittal.IMU_TVCFDeg_sagittal, DEG_SCALING_FACTOR);
	ScaledDataObj.Scaled_rightHipImuFrontalRoll = ScaleFloatToInt16(RH_Sagittal.IMU_TVCFDeg_frontal, DEG_SCALING_FACTOR);
	ScaledDataObj.Scaled_rightHipImuSagittalPitch = ScaleFloatToInt16(RH_Sagittal.IMU_TVCFDeg_sagittal, DEG_SCALING_FACTOR);
