...
// 								  TASK_ID_LOWLEVEL, PDO_ID_LOWLEVEL_TOTAL_CURRENT_INPUT,
								  ...
								  TASK_ID_GAIT, PDO_ID_GAIT_IMU_TVCF_ROLL,
								  TASK_ID_GAIT, PDO_ID_GAIT_IMU_TVCF_PITCH,
								//   TASK_ID_GAIT, PDO_ID_GAIT_IMU_TVCF_YAW,
...
static void SetupDOD(AS_CtrlObj_t* obj)
{
	...
	DOPI_SetPDOAddr(&obj->devObj, TASK_ID_GAIT,	PDO_ID_GAIT_IMU_TVCF_ROLL,		&obj->data.IMU_TVCFDeg_frontal);
	DOPI_SetPDOAddr(&obj->devObj, TASK_ID_GAIT,	PDO_ID_GAIT_IMU_TVCF_PITCH,		&obj->data.IMU_TVCFDeg_sagittal);
	DOPI_SetPDOAddr(&obj->devObj, TASK_ID_GAIT,	PDO_ID_GAIT_IMU_TVCF_YAW,		&obj->data.IMU_TVCFDeg_yaw);
	...
	DOPI_SetPDOAddr(&obj->devObj, TASK_ID_GAIT,	PDO_ID_GAIT_THIGH_NEUTRAL_POSTURE_DEG,	&obj->data.thighNeutralPostureDeg);
