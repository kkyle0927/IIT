 ...
 */
#define IOIF_SPI_RECOVERY_TIME_INTERVAL 20 // 20ms
...
typedef enum _IOIF_SPI_t {
    IOIF_SPI1 = BSP_SPI1,  ///< SPI 1 Identifier
    IOIF_SPI2 = BSP_SPI2,      ///< SPI 2 Identifier
    IOIF_SPI3 = BSP_SPI3,      ///< SPI 3 Identifier
    IOIF_SPI4 = BSP_SPI4,      ///< SPI 4 Identifier
    IOIF_SPI_COUNT
} IOIF_SPI_t;
