...
typedef struct _DOPI_BT_DevObj_t{
	DOPI_TaskObj_t tasks[BT_TASK_NUM];
	uint32_t noti;
	uint16_t errCode;
	uint8_t  nodeID;
	uint8_t  numOfTask;
...
extern bool rightHipNPOffsetFlag;
extern bool leftHipNPOffsetFlag;
extern bool rightKneeNPOffsetFlag;
extern bool leftKneeNPOffsetFlag;
