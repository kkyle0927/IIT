...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.TransmitPause = ENABLE;
  hfdcan1.Init.ProtocolException = DISABLE;
  hfdcan1.Init.NominalPrescaler = 10;//1;
  hfdcan1.Init.NominalSyncJumpWidth = 2;// 32;
  hfdcan1.Init.NominalTimeSeg1 = 5;//127;
  hfdcan1.Init.NominalTimeSeg2 = 2;//32;
  hfdcan1.Init.DataPrescaler = 1;
  hfdcan1.Init.DataSyncJumpWidth = 4;
  hfdcan1.Init.DataTimeSeg1 = 11;
  hfdcan1.Init.DataTimeSeg2 = 4;
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.TransmitPause = ENABLE;
  hfdcan2.Init.ProtocolException = DISABLE;
  hfdcan2.Init.NominalPrescaler = 10;//1;
  hfdcan2.Init.NominalSyncJumpWidth = 2;// 32;
  hfdcan2.Init.NominalTimeSeg1 = 5;//127;
  hfdcan2.Init.NominalTimeSeg2 = 2;//32;
  hfdcan2.Init.DataPrescaler = 1;
  hfdcan2.Init.DataSyncJumpWidth = 4;
  hfdcan2.Init.DataTimeSeg1 = 11;
  hfdcan2.Init.DataTimeSeg2 = 4;
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  */
    ...
    PD1     ------> FDCAN1_TX
    */
    GPIO_InitStruct.Pin = MC_FDCAN1_RX_Pin|MC_FDCAN1_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_FDCAN1;
   ...
   */
     ...
     PD1     ------> FDCAN2_TX
     */
     GPIO_InitStruct.Pin = MC_FDCAN2_RX_Pin|MC_FDCAN2_TX_Pin;
     GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
     GPIO_InitStruct.Pull = GPIO_NOPULL;
     GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
     GPIO_InitStruct.Alternate = GPIO_AF9_FDCAN2;
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  /* USER CODE END FDCAN1_MspDeInit 0 */
    ...
    PD1     ------> FDCAN1_TX
    */
    HAL_GPIO_DeInit(GPIOD, MC_FDCAN1_RX_Pin|MC_FDCAN1_TX_Pin);
  ...
  /* USER CODE END FDCAN2_MspDeInit 0 */
    ...
    PD1     ------> FDCAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, MC_FDCAN2_RX_Pin|MC_FDCAN2_TX_Pin);
