 ...
 */
LTC29444State_t LTC2944_SetIoctx(LTC2944Obj_t* ltc2944Obj, LTC2944IOctx_t* ltc2944IOctx)
{
 ...
 * @return uint8_t status code.
 */
LTC29444State_t LTC2944_Init(LTC2944Obj_t* ltc2944Obj)
{
    // Check for valid pointers and functions
    if (!ltc2944Obj) {
        return LTC2944_STATUS_ERROR;
    ...
    LTC29444State_t status = LTC2944_STATUS_ERROR;
