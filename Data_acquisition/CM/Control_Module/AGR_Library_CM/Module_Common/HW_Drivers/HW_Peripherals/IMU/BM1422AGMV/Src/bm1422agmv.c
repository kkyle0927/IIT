 ...
 */
BM1422AGMVState_t BM1422AGMV_SetIoctx(BM1422AGMVObj_t* bm1422agmvObj, BM1422AGMVIOctx_t* bm1422agmvIOctx)
{
 ...
 * @return BM1422AGMV status code.
 */
BM1422AGMVState_t BM1422AGMV_Init(BM1422AGMVObj_t* bm1422agmvObj)		// Setting control register
{
    // Check for valid pointers and functions
    if (!bm1422agmvObj) {
        return BM1422AGMV_STATUS_ERROR;
 ...
 * @return BM1422AGMV status code.
 */
BM1422AGMVState_t BM1422AGMV_GetValue(BM1422AGMVObj_t* bm1422agmvObj)
{
