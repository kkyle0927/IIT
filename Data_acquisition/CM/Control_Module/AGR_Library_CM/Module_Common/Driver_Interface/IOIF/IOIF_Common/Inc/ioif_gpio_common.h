...
typedef enum _IOIF_GPIOPort_t {
    IOIF_GPIO_PORT_A = BSP_GPIO_PORT_A,      ///< GPIO A Identifier
    IOIF_GPIO_PORT_B = BSP_GPIO_PORT_B,      ///< GPIO B Identifier
    IOIF_GPIO_PORT_C = BSP_GPIO_PORT_C,      ///< GPIO C Identifier
    IOIF_GPIO_PORT_D = BSP_GPIO_PORT_D,      ///< GPIO D Identifier
    IOIF_GPIO_PORT_E = BSP_GPIO_PORT_E,      ///< GPIO E Identifier
    IOIF_GPIO_PORT_F = BSP_GPIO_PORT_F,      ///< GPIO F Identifier
    IOIF_GPIO_PORT_G = BSP_GPIO_PORT_G,      ///< GPIO G Identifier
    IOIF_GPIO_PORT_H = BSP_GPIO_PORT_H,      ///< GPIO H Identifier
    IOIF_GPIO_PORT_I = BSP_GPIO_PORT_I,      ///< GPIO I Identifier
    IOIF_GPIO_PORT_J = BSP_GPIO_PORT_J,      ///< GPIO J Identifier
    IOIF_GPIO_PORT_K = BSP_GPIO_PORT_K,      ///< GPIO K Identifier
