 ...
 */
#define IOIF_I2C_RECOVERY_TIME_INTERVAL      20      // 20ms
...
IOIF_I2CState_t IOIF_I2C_InitRecovery(IOIF_I2C_t i2c, IOIF_GPIOPort_t sda_port, uint16_t sda_pin, IOIF_GPIOPort_t scl_port, uint16_t scl_pin);
