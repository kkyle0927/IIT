...
#define IOIF_FDCAN_TX_BUFF_SIZE 256
#define IOIF_FDCAN_RX_BUFF_SIZE 256
...
extern uint8_t fdcan_rx_buff[64];
 ...
 */
/*IOIF_FDCANState_t IOIF_FDCAN_InitCH1(uint32_t nodeId);
IOIF_FDCANState_t IOIF_FDCAN_InitCH2(uint32_t nodeId);
IOIF_FDCANState_t IOIF_FDCAN_TransmitCH1(uint16_t msgId, uint8_t* txData, uint32_t len);
IOIF_FDCANState_t IOIF_FDCAN_TransmitCH2(uint16_t msgId, uint8_t* txData, uint32_t len);
*/
