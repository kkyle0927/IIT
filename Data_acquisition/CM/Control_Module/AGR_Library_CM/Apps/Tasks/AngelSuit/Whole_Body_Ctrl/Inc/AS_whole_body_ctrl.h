...
typedef struct {
    ...
    // IMU TVCF 각도(deg)
    float IMU_BodyAngle_Sagittal;
    float IMU_BodyAngle_Frontal;
    float IMU_BodyAngle_Transverse;
...
extern double AsymmetryAvgSum;
extern uint32_t AsymmetryAvgCnt;
...
extern float RH_IMU_BodyAngle_Sagittal, LH_IMU_BodyAngle_Sagittal;
extern float RH_IMU_BodyAngle_Frontal, LH_IMU_BodyAngle_Frontal;
extern float RK_PositionAct;
extern float LK_PositionAct;
extern float RK_EncoderVelocity;
extern float LK_EncoderVelocity;
extern float RK_IMU_BodyAngle_Sagittal, LK_IMU_BodyAngle_Sagittal;
extern float RK_IMU_BodyAngle_Frontal, LK_IMU_BodyAngle_Frontal;
