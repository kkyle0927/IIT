...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_SAI1|RCC_PERIPHCLK_CKPER;
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.BaseAddress = 0x90000000;				// for Quad SPI Memory Mapped Mode
