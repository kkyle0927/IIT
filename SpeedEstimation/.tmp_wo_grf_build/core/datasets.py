...
class LazyWindowDataset(Dataset):
    def __init__(self, X_list, Y_list, input_window, output_window, stride, target_mode="sequence", est_tick_ranges=None, augment=False, noise_std=0.0, ar_k=0, device=None, time_warp_sigma=0.0, noise_std_per_dim=None, target_transform=None, input_mean=None, input_std=None):
        """
