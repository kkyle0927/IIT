...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        # 모드 라벨 + 패킷 에러 라벨 (한 줄에 표시)
        mode_line = QtWidgets.QHBoxLayout()
        ...
        mode_line.addWidget(self.mode_label)

        # 모드 정보와 에러 라벨 사이 간격
        mode_line.addSpacing(30)
        ...
        mode_line.addWidget(self.error_label)

        mode_line.addStretch()
        vbox.addLayout(mode_line)
