...
Exoskeleton 착용 환경에서 IMU + exo 센서만으로 treadmill 보행 속도를 추정하는 딥러닝 프로젝트.
...
- 데이터: `combined_data.h5` (symlink), 구조: `Subject/Condition/Level/Trial`
...
- `_dot`, `_ddot` 변수: `np.gradient() * fs`로 계산
