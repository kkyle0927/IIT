...
def compute_robot_biomech_rt_features(
    ...
    height_m, weight_kg, fs_hz=100.0
):
    ...
    body_frame = estimate_body_frame_features(
        imu_acc_local, imu_gyro_local, imu_quat_wxyz,
        np.zeros(len(hip_l), dtype=np.float32), fs_hz
    )
