...
if __name__ == "__main__":
    ...
    # Run Distribution Analysis at the very beginning (disabled by default)
    if args.run_distribution_analysis and args.rank == 0:
        ...
        print("[INFO] Skipping distribution analysis (use --run_distribution_analysis to enable)")
    ...
    if not args.run_feature_importance:
        print("[INFO] Skipping feature importance (use --run_feature_importance to enable)")
        sys.exit(0)
