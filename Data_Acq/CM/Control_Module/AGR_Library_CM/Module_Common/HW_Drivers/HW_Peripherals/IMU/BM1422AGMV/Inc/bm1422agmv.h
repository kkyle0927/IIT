...
#define BM1422AGMV_RECOVERY_TRAILS	 3
...
BM1422AGMVState_t BM1422AGMV_Init(BM1422AGMVObj_t* bm1422agmv_obj);

// Initialize the BM1422AGMV object.
BM1422AGMVState_t BM1422AGMV_SetIoctx(BM1422AGMVObj_t* bm1422agmv_obj, BM1422AGMVIOctx_t* bm1422agmvIOctx);

// Retrieve the magnet data values from the BM1422AGMV object.
BM1422AGMVState_t BM1422AGMV_GetValue(BM1422AGMVObj_t* bm1422agmv_obj);
