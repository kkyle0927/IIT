...
/* GAIT CONTROL ERROR - Error_Type */
#define ERROR_IMU_SENSOR_RAW_OVER_THRESHOLD 0x1600
#define ERROR_IMU_SENSOR_GET_VALUE          0x1601

typedef enum {
	CURRENT_SENSOR_ABNORMAL_PHASE_A,
	CURRENT_SENSOR_ABNORMAL_PHASE_B,
	CURRENT_SENSOR_ABNORMAL_PHASE_C,
	CURRENT_OFFSET_ERROR_PHASE_A,
	CURRENT_OFFSET_ERROR_PHASE_B,
	CURRENT_OFFSET_ERROR_PHASE_C,
	CURRENT_OFFSET_RATIONALITY_ERROR,
	OVER_CURRENT_HW_FAULT,
	OVER_CURRENT_SW_FAULT,
	OVER_LOAD_FAULT,
	OVER_VOLTAGE_VDC,
	UNDER_VOLTAGE_VDC,
}LowLvFaultList_t;
...
typedef enum {
	OTP_DERATING_CONTROL,
	OTP_DERATING_WARNING_ALARM,
	STALL_DERATING_CONTROL,
	STALL_DERATING_WARNING_ALARM
}WarnigList_t;
