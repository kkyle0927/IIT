...
/** @brief EMG Hub Module (단일 채널, TPDO1만 사용) */
#define AGR_NODE_ID_EMG_HUB         0x0A

/** @brief FES Hub Module (2-ch Biphasic FES Stimulator, TPDO1 + RPDO1) */
#define AGR_NODE_ID_FES_HUB         0x0B
