...
/**
 * @brief 정적 메모리 풀을 초기화합니다.
 * @details 시스템 재초기화 시 호출하여 풀을 리셋합니다.
 *          모든 TSM 객체가 무효화되므로, TSM_Init/AddState를 다시 수행해야 합니다.
 */
 ...
 * @note  동일 state_id가 이미 등록된 경우 콜백만 갱신합니다.
 */
 ...
 */
int TSM_TransitionTo(TaskStateMachine_t* tsm, uint8_t next_state_id);
