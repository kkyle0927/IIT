 ...
 *          module.h Task Priority Map(55 > 54) 의 설계 의도를 코드로 실현하는 지점.
 *          FDCAN RxTask 기본값 osPriorityRealtime4(52) 는 UserTask(54)에 역전되므로
 *          55 로 올려 RxTask > UserTask 보장 ("빠른 PDO"; 느린 SDO 는 NonRealtimeTask 51 로 분리).
 */
#define IOIF_UART_RX_TASK_PRIORITY      (osPriorityRealtime7)  /**< 기본 50 → 55 */
#define IOIF_FDCAN_RX_TASK_PRIORITY     (osPriorityRealtime7)  /**< 기본 52 → 55: V4.0 PDO RxTask > UserTask(54) */
